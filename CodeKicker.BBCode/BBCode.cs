            ...
            return new BBCodeParser(ErrorMode.ErrorFree, null, new[]
                {
                    ...
                    new BBTag("img", "<img src=\"${content}\" />", "", autoRenderContent: false, requireClosingTag: true, 4, allowUrlProcessingAsText: false), 
                    new BBTag("quote", "<blockquote>", "</blockquote>", 0), 
                    new BBTag("list", "<ul>", "</ul>", 9), 
                    new BBTag("*", "<li>", "</li>", autoRenderContent: true, requireClosingTag: false, 13), 
